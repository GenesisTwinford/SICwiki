...
export default function SignInPage() {
  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#eff6ff_0%,#ffffff_52%,#fff7ed_100%)] px-4 py-10">
      <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-5xl items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <section className="rounded-[32px] border border-black/10 bg-white/85 p-6 shadow-[0_25px_70px_-35px_rgba(15,23,42,0.35)] sm:p-8">
          <div className="space-y-4">
            <div>
              <h2 className="text-2xl font-semibold text-slate-950">ログイン</h2>
              <p className="mt-2 text-sm text-slate-600">
                メールアドレスとパスワード、または Google で続行できます。
              </p>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full rounded-2xl bg-slate-900 px-4 py-3 text-sm font-medium text-white transition hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
